...
export const bookingsApi = {
  ...
  duplicate: (id) => api.post(`/bookings/${id}/duplicate`),
  duplicateAll: (year) => api.post('/bookings/duplicate-all', null, { params: { year } }),
  ...
  sendHotelRequestTelegram: (bookingId, hotelId, chatId) => api.post(`/bookings/${bookingId}/send-hotel-request-telegram/${hotelId}`, { chatId }),
  // Cost Summary
