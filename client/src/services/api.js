...
export const telegramApi = {
  ...
  sendEintritt: (bookingId, formData) => api.post(`/telegram/send-eintritt/${bookingId}`, formData, {
    headers: { 'Content-Type': 'multipart/form-data' }
  }),
  ...
  sendShouTelegram: (bookingId) => api.post(`/telegram/send-shou/${bookingId}`),
  getShouSettings: () => api.get('/telegram/shou-settings'),
  saveShouSettings: (chatId) => api.put('/telegram/shou-settings', { chatId }),
  ...
  getRestaurantList: () => api.get('/telegram/restaurant-list'),
...
export const jahresplanungApi = {
  ...
  clearHotelTg: (hotelId, tourType, year) =>
    api.put(`/jahresplanung/clear-tg/${hotelId}/${tourType}/${year}`),
  clearMealTg: (restaurantName, year) =>
    api.put(`/jahresplanung/clear-meal-tg/${year}`, { restaurantName }),
  clearTransportTg: (provider, year) =>
    api.put(`/jahresplanung/clear-transport-tg/${provider}/${year}`),
  clearGuideTg: (guideId, year) =>
    api.put(`/jahresplanung/clear-guide-tg/${guideId}/${year}`),
